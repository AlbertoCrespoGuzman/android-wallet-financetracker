...
package ta.na.mao.activities;
        ...
        import ta.na.mao.databinding.ActivityUserDetailsOldBinding;
        import ta.na.mao.utils.ErrorMessage;
        import ta.na.mao.utils.Utils;
        import ta.na.mao.utils.adapters.ArrayAdapterCustomSpinner;

public class UserDetailsOldActivity extends AppCompatActivity implements Serializable{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityUserDetailsOldBinding binding;
        ...
        cpf.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if(actionId == EditorInfo.IME_ACTION_DONE ||
                    ...
                    Utils.hideKeyboard(UserDetailsOldActivity.this);
                }
                return false;
            }
        });
        ...
        if(backEnabled){
            ...
            back.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(UserDetailsOldActivity.this,
                            MainActivity.class));
                    finish();
                }
            });
        ...
        if(db.findUserDetails() != null){
            ...
            if(userDetails.getMobilenumber() != null && userDetails.getMobilenumber().length() == 14){
                Mobile mobile = new Mobile();
                mobile.setState(userDetails.getMobilenumber().substring(3,5));
                mobile.setNumber(userDetails.getMobilenumber().substring(5));
        ...
        binding.setHandlerformold(new Handlerformold());
    ...
    public void onclickSubmit(View v){
        ...
        if(userDetails.validator(getApplicationContext(), errors, new View(getApplicationContext())).isEmpty()){
            ...
            try {
                ...
                startActivity(new Intent(UserDetailsOldActivity.this, MainActivity.class));
                finish();
    ...
    public void onResume(){
        super.onResume();
        svcAuth = Svc.initAuth(UserDetailsOldActivity.this);
        db = new DatabaseManager(UserDetailsOldActivity.this);
    }
    ...
    private void showErrors(){
        ...
        */
        Log.e("showErrors", "PUTO ERROR " + errors.get(0).getMessage());
        ...
        private DatePickerDialog.OnDateSetListener dateSetListener =
                new DatePickerDialog.OnDateSetListener() {
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        ((UserDetailsOldActivity)  getActivity()).receiveDate(view.getDayOfMonth() +
