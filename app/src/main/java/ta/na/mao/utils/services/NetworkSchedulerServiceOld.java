...
public class NetworkSchedulerServiceOld extends IntentService implements
        ConnectivityReceiver.ConnectivityReceiverListener {

    private ConnectivityReceiver mConnectivityReceiver;

    public NetworkSchedulerServiceOld() {
        super("Cashback IntentService");
    }

    @Override
    protected void onHandleIntent(Intent intent) {
        Log.e("!!!!!!!!!!!!!!", "NetworkSchedulerServiceOld onHandleIntent intent");
        mConnectivityReceiver = new ConnectivityReceiver(this);
    }

    @Override
    public void onNetworkConnectionChanged(boolean isConnected) {
        String message = isConnected ? "OLDDDD Good! Connected to Internet" : "Sorry! Not connected to internet";
    ...
    static public void updateData(Context context){
        ...
        if(servicePrices == null || servicePrices.isEmpty()){
          /*  List<FixedCost> fixedCosts = db.findFixedCostServicePriceNotUpdated();
            ...
            if(!servicePrices.isEmpty()) sendServicePrices(servicePrices, context); Log.e("sendServicePrices", "sending " + userDetails.size() + " userDetails");
...
/*
            ...
            */
            ...
            if(!productPrices.isEmpty()) sendProductPrices(productPrices, context); Log.e("sendServicePrices", "sending " + userDetails.size() + " userDetails");
