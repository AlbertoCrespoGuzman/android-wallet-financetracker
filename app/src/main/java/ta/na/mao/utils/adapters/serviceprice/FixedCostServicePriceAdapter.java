...
public class FixedCostServicePriceAdapter   extends RecyclerView.Adapter<FixedCostServicePriceAdapter.ViewHolder> {
    ...
    public FixedCostServicePriceAdapter(ServicePriceFormFragment context, List<FixedCost> fixedCosts) {
    ...
    @Override
    public FixedCostServicePriceAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        this.parent = parent;
        View view = mInflater.inflate(R.layout.adapter_simple_two_elements, parent, false);
        return new FixedCostServicePriceAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(FixedCostServicePriceAdapter.ViewHolder holder, int position) {
