...
public class LabourCostServicePriceAdapterForDialog  extends RecyclerView.Adapter<LabourCostServicePriceAdapterForDialog.ViewHolder> {
    ...
    public LabourCostServicePriceAdapterForDialog(ServicePriceMainFragment context, List<LabourCost> labourCosts) {
    ...
    @Override
    public LabourCostServicePriceAdapterForDialog.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        this.parent = parent;
        View view = mInflater.inflate(R.layout.adapter_simple_four_elements, parent, false);
        return new LabourCostServicePriceAdapterForDialog.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(LabourCostServicePriceAdapterForDialog.ViewHolder holder, int position) {
