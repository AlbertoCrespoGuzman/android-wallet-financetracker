...
public class ArrayAdapterCustomSpinner<T> extends BaseAdapter implements Filterable, ThemedSpinnerAdapter {
/**
 ...
 */
public ArrayAdapterCustomSpinner(@NonNull Context context, @LayoutRes int resource, @NonNull T[] objects) {
 ...
 * @param objects The objects to represent in the ListView.
 */
public ArrayAdapterCustomSpinner(@NonNull Context context, @LayoutRes int resource,
...
private ArrayAdapterCustomSpinner(@NonNull Context context, @LayoutRes int resource,
...
final T item = getItem(position);
        ...
        Typeface face=Typeface.createFromAsset(getContext().getAssets(), "fonts/normal.ttf");
 ...
 * {@link android.content.Context} passed to the adapter's constructor.
 *
...
final LayoutInflater inflater = mDropDownInflater == null ? mInflater : mDropDownInflater;
    ...
    if (convertView == null) {
        ...
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.spinner_text_normal, parent, false);
        TextView textView  = view.findViewById(R.id.spinner_normal_text_textview);
        Typeface face=Typeface.createFromAsset(getContext().getAssets(), "fonts/normal.ttf");
        ...
        textView.post(new Runnable() {
            ...
            public void run() {
                ...
                finalItem.setMaxLines(2);
                finalItem.setLines(2);
            }
        });
        ...
        parent.setBackgroundColor(getContext().getResources().getColor(R.color.colorPrimary));
        view.setBackgroundColor(getContext().getResources().getColor(R.color.colorPrimary));
        return createViewFromResource(inflater, position, view, parent, mDropDownResource);
        }
 ...
 */
public static @NonNull ArrayAdapterCustomSpinner<CharSequence> createFromResource(@NonNull Context context,
                                                                                  @ArrayRes int textArrayResId, @LayoutRes int textViewResId) {
final CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new ArrayAdapterCustomSpinner<>(context, textViewResId, 0, Arrays.asList(strings), true);
        }
